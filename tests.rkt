...
(check-exn
   exn:fail? (lambda () (interpret "test11.bad"))) ; fail
(check-exn
...
(check-equal? (interpret "test18.bad") 'true) ; fail
(check-equal? (interpret "test19.bad") 128) ; fail
(check-equal? (interpret "test20.bad") 12) ; fail
...
(check-exn
   exn:fail? (lambda () (update-binding 'x 12 '(((a) (10)))) 'error))
