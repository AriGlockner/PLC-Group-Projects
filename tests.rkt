...
; (M_state_while '(< x 9) '(begin (= x (+ x 1)) (break) (= y 8))  state (lambda (v) v))

(M_state_if '(if (< x 9) (begin (= x (+ x 1)) (= y 8))) state (lambda (v) v) (lambda (v) v))
(M_state_if '(if (< x 9) (begin (= x (+ x 1)) (break) (= y 8))) state (lambda (v) v) (lambda (v) v))