...
(check-equal? (interpret "tests/p2_t5.bad") "error: undefined variable min")
...
(check-equal? (interpret "tests/p2_t11.bad") "error: undefined variable y")
(check-equal? (interpret "tests/p2_t12.bad") "error: undefined variable a")
(check-equal? (interpret "tests/p2_t13.bad") "Break used outside of loop")
...
(check-equal? (interpret "tests/p2_t19.bad") "Uncaught exception thrown")
